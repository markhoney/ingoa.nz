<template>
	<v-card>
		...
		<v-card-title primary-title>
			<div>
				<h3 class="headline mb-0"><nuxt-link :to="localePath({name: 'islands-island', params: {island: island.code}})">{{localeName(island.names)}}</nuxt-link></h3>
				<h3>{{localeAltName(island.names)}}</h3>
