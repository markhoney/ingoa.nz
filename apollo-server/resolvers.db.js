...
module.exports = function(db) {
	return {
		island: {
			...
			/*image(obj) {
				return {
					banner: /media/images/island/ + obj.code + -banner.jpg,
					landscape: /media/images/island/ + obj.code + -landscape.png,
					portrait: /media/images/island/ + obj.code + .png
				}
			},*/
			/*code() {
		...
		part: {
			...
			/*image(obj) {
				return {
					portrait: /media/images/part/ + obj.code + -front.png
				}
			},*/
		},
		...
		map: {
			...
			/*image(map) {
				return {
					portrait: /media/images/map/ + map.code + -trans.png
				}
			},*/
		},
		...
		zone: {
			...
			/*image(zone) {
				return {
					landscape: /media/images/region/ + zone.code + -landscape.png
				}
			},*/
		},
